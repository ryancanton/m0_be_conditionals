...
#These lines check if the door_choice value is 1. If so, it assigns "hat" to bear clothing.
#Otherwise, it assigns "scarf" to bear clothing
...
#The program checks what bear_choice is, and outputs a different message for each case (1,2,3, or other)
